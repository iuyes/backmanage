 ...
 * abc namespace
 */
var AliyunBusinessCenter = {};


AliyunBusinessCenter.version = '1.0.0';


AliyunBusinessCenter._data = {};


AliyunBusinessCenter._util = {};


AliyunBusinessCenter._fn = {};

/**
 * module
 */
AliyunBusinessCenter._module = {};

/**
 * Qatrix 轻型 js 框架
 */
AliyunBusinessCenter._Qatrix = {};;/*
...
(function (window, document, abc, undefined) {
...
// 这里修改源码，将 Qatrix 挂载到 AliyunBusinessCenter 下
for (var fn in Qatrix)
{
    abc._Qatrix[fn] = Qatrix[fn];
}

Qatrix.version = version;
abc._Qatrix.version = version;
...
var $ = Qatrix.$,
    ...
    $tag = Qatrix.$tag,
    $class = Qatrix.$class,
    $select = Qatrix.$select,

    // Animation
    $animate = Qatrix.$animate,
    $fadein = Qatrix.$fadein,
    $fadeout = Qatrix.$fadeout,
    ...
    $new = Qatrix.$new,
    $append = Qatrix.$append,
    $prepend = Qatrix.$prepend,
    $before = Qatrix.$before,
    $after = Qatrix.$after,
    $remove = Qatrix.$remove,
    $empty = Qatrix.$empty,
    $html = Qatrix.$html,
    $text = Qatrix.$text,
    ...
    // Storage
    $storage = Qatrix.$storage,

    // Miscellaneous
    $each = Qatrix.$each,
    $clear = Qatrix.$clear,
    $rand = Qatrix.$rand,
    $browser = Qatrix.$browser;
...
})(window, document, AliyunBusinessCenter);;/**
 * abc._util
 */
