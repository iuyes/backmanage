...
return function($){
 ...
 // var template = '<div class=window><div class=windowtitlebar><img src=/favicon.ico width=16 height=16 class=titlebaricon><div class=titlebartext></div><div class=horizbuts><div class=minimizebut title=minimize></div><div class=restorebut title=restore></div><div class=maximizebut title=maximize></div><div class=closebut title=close></div></div></div><div class=windowcontent></div><div class=resizer-tl></div><div class=resizer-t></div><div class=resizer-tr></div><div class=resizer-r></div><div class=resizer-br></div><div class=resizer-b></div><div class=resizer-bl></div><div class=resizer-l></div></div>';
  var template = '<div class=window><div class=windowtitlebar><div class=titlebartext></div><div class=horizbuts><div class=minimizebut title=最小化></div><div class=restorebut title=恢复></div><div class=maximizebut title=最大化></div><div class=closebut title=关闭></div></div></div><div class=windowcontent></div><div class=resizer-tl></div><div class=resizer-t></div><div class=resizer-tr></div><div class=resizer-r></div><div class=resizer-br></div><div class=resizer-b></div><div class=resizer-bl></div><div class=resizer-l></div></div>';
  ...
  methods.open = function(lnk,target,opts) {
    ...
    // 增加 closeWindowCallback 参数
    buts.eq(3).click(function(){
    	$(this).closest('.window').WM('close');
    	if (typeof opts.closeWindowCallback != 'undefined' && $.isFunction(opts.closeWindowCallback)) {
    		opts.closeWindowCallback.call();
    	}
    ...
    if (typeof opts.pos != 'undefined') {
        var left = opts.pos.left ? opts.pos.left : 'auto';
        var top = opts.pos.top ? opts.pos.top : 'auto';
        var right = opts.pos.right ? opts.pos.right : 'auto';
        var width = opts.pos.width ? opts.pos.width : 'auto';
        var height = opts.pos.height ? opts.pos.height : 'auto';
