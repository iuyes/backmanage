 ...
 * @Descript	: remote ajax验证，判断response的state标头，提示内容在response.message[0]；remote验证时的startRequest方法下移；验证码错误&刷新
 * $Id: jquery.validate.js 6088 2012-03-16 07:54:01Z hao.lin $
 */
